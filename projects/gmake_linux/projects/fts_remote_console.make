...
ifeq ($(config),debug32)
  ...
  TARGETDIR           = ../bin/x32_debug_gmake/fts_remote_console
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x32_debug_gmake/imgui -L../bin/x32_debug_gmake/net -L. -m32
  LDDEPS             += ../bin/x32_debug_gmake/imgui/libimgui.a ../bin/x32_debug_gmake/imgui/libglfw.a ../bin/x32_debug_gmake/net/libnet.a
  LIBS               += $(LDDEPS) -lGL -lglut -lXrandr -lXinerama -lXcursor
  EXTERNAL_LIBS      +=
...
ifeq ($(config),release32)
  ...
  TARGETDIR           = ../bin/x32_release_gmake/fts_remote_console
  TARGET              = $(TARGETDIR)/fts_remote_console
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x32_release_gmake/imgui -L../bin/x32_release_gmake/net -L. -s -m32
...
ifeq ($(config),debug64)
  ...
  TARGETDIR           = ../bin/x64_debug_gmake/fts_remote_console
  TARGET              = $(TARGETDIR)/fts_remote_console
  DEFINES            += -DASIO_STANDALONE -DDEBUG -DFTS_LINUX
  INCLUDES           += -I../../../code/thirdparty -I../../../code/thirdparty/asio -I../../../code/thirdparty/imgui -I../../../code/thirdparty/glfw/include -I../../../code
  INCLUDES           +=
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x64_debug_gmake/imgui -L../bin/x64_debug_gmake/net -L. -m64
...
ifeq ($(config),release64)
  ...
  TARGETDIR           = ../bin/x64_release_gmake/fts_remote_console
  TARGET              = $(TARGETDIR)/fts_remote_console
  DEFINES            += -DASIO_STANDALONE -DNDEBUG -DFTS_LINUX
  INCLUDES           += -I../../../code/thirdparty -I../../../code/thirdparty/asio -I../../../code/thirdparty/imgui -I../../../code/thirdparty/glfw/include -I../../../code
  INCLUDES           +=
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x64_release_gmake/imgui -L../bin/x64_release_gmake/net -L. -s -m64
