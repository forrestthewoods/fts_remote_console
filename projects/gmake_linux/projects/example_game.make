...
ifeq ($(config),debug32)
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x32_debug_gmake/net -L. -m32
...
ifeq ($(config),release32)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x32_release_gmake/net -L. -s -m32
...
ifeq ($(config),debug64)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x64_debug_gmake/net -L. -m64
...
ifeq ($(config),release64)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x64_release_gmake/net -L. -s -m64
