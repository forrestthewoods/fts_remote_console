...
ifeq ($(config),debug32)
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x32_debug/imgui -L../bin/x32_debug/net -L. -m32 -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreVideo
...
ifeq ($(config),release32)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x32_release/imgui -L../bin/x32_release/net -L. -m32 -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreVideo
...
ifeq ($(config),debug64)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x64_debug/imgui -L../bin/x64_debug/net -L. -m64 -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreVideo
...
ifeq ($(config),release64)
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L../bin/x64_release/imgui -L../bin/x64_release/net -L. -m64 -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreVideo
