...
namespace fts {
    ...
    class Timer 
    {
      public:
        ...
        double RemainingMilliseconds() const;
    ...
    inline double Timer::RemainingMilliseconds() const {
        return Finished() ? 0 : (duration * 1000.0) - stopwatch.elapsedMilliseconds();
    }

    inline double Timer::RemainingSeconds() const {
        return Finished() ? 0 : duration - stopwatch.elapsedSeconds();
    }
