...
namespace fts {
    ...
    static bool fuzzy_match(char const * pattern, char const * str, char const * str_end)
    {
        while (*pattern != '\0' && *str != '\0' && (str_end == nullptr || str <= str_end)) {
    ...
    static bool fuzzy_match(int & outScore, char const * pattern, char const * str, char const * str_end)
    {
        // Score consts
        ...
        // Loop over strings
        while (*strIter != '\0' && (str_end == nullptr || str <= str_end))
        {
